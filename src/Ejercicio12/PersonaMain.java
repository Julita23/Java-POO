...
public class PersonaMain {
    ...
    public static void main(String[] args) {
         ...
         System.out.println(persona.getNombre()+ " tiene "+ servicio.calcularEdad(persona)+" anios.");
         System.out.println("Ingrese una edad para comparar: ");
         int edad = sc.nextInt();
         
         boolean menor = servicio.menorQue(servicio.calcularEdad(persona), edad);
         
         if(menor== true){
             System.out.println(persona.getNombre()+ " es menor");
         }else{
             System.out.println(persona.getNombre()+" es mayor");
         }
    }
